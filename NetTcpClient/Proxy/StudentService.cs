...
namespace NetTcpServer
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="StudentInfo", Namespace="http://schemas.datacontract.org/2004/07/NetTcpServer")]
...
public interface IStudentService
{
    ...
    NetTcpServer.StudentInfo[] GetStudentInfo(int studentId);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStudentService/GetStudentInfo", ReplyAction="http://tempuri.org/IStudentService/GetStudentInfoResponse")]
    System.Threading.Tasks.Task<NetTcpServer.StudentInfo[]> GetStudentInfoAsync(int studentId);
}
...
public partial class StudentServiceClient : System.ServiceModel.ClientBase<IStudentService>, IStudentService
{
    ...
    public NetTcpServer.StudentInfo[] GetStudentInfo(int studentId)
    {
        return base.Channel.GetStudentInfo(studentId);
    }
    
    public System.Threading.Tasks.Task<NetTcpServer.StudentInfo[]> GetStudentInfoAsync(int studentId)
    {
